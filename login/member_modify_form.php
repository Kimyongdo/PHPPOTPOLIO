...
<html>
    ...
    <body>
        ...
        <!-- 로그인 되어있는 회원의 정보를 읽어오는 php코드 작성 -->
        <?php
        ...
        <section>
            <div id="main_content">
                <div id="join_box">
                    <!-- DB의 member테이블에 정보를 수정하는 member_modify.php에 입력값들 전달하도록 -->
                    <!-- 아이디만 보내는 방식을 채용  -->
                    <form action="./member_modify.php?id=<?=$userid?>" method="post" name="member_form">
                        ...
                        <!-- input요소의 submit, reset으로 만들면 이미지로 못 만듦 -->
                        <!-- input요소의 타입 중 image 타입으로 하면 이미지버튼이면서 submit기능 -->
                        <!-- 값을 전송할 때 값이 비어있는지 검증하는 작업도 하고싶어서.. -->
